		...
		$(function(){
			...
			$("#regEmail").blur(function(){
				$.ajax({
					...
					url:"${pageContext.request.contextPath}/front/chenkemail.action",
	...
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="loginForm" action="front/user/login.do" method="post">
				...
				<div id="forget">
					<a href="front/forgetpwd1.action">忘记密码？</a>
				</div>
	...
	<div class="mask_content">
		...
		<div class="mask_content_body">
			<form id="regForm" action="front/user/regist.do" method="post">
				<h3>新用户注册</h3>
				<input type="email" id="regEmail" placeholder="请输入邮箱" name="email"><span id="spp"></span>
