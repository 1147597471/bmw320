                        ...
                        <div class="profile_ifo_area">
                            <form action="front/user/profile.action" method="post">
                                ...
                                <div class="form_group">
                                    ...
                                    <input type="date"  name="birthday" value="<fmt:formatDate value="${user.birthday}"  type="both"  pattern="yyyy-MM-dd"/>" >
                                </div>
                                <div class="form_group">
                                    <span class="dd" >邮&#x3000;箱：</span>
                                    <span ><input type="text" value="${user.email}" name="email"></span>
                                </div>
                                <div class="form_group">
